...
_NONNULL int hfs_get_hotfiles_btree(BTreePtr *tree, const HFS *hfs);
_NONNULL int hfs_hotfiles_get_node(BTreeNodePtr *node, const BTreePtr bTree, bt_nodeid_t nodeNum);

_NONNULL uint32_t HFCGetFileTemperature(HFS *hfs, bt_nodeid_t fileID, hfs_forktype_t forkType);
